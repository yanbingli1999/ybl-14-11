...
export const GAME_CONFIG = {
  ...
  LOAD_PER_MATCH: 1,
  AUCTION_MIN_BUYERS: 2,
  AUCTION_MAX_BUYERS: 4,
  AUCTION_BASE_PRICE_MIN: 3,
  AUCTION_BASE_PRICE_MAX: 8,
  AUCTION_SCARCITY_MULTIPLIER: 1.5,
  AUCTION_SURPLUS_MULTIPLIER: 0.7,
  AUCTION_REPUTATION_BONUS: 0.002,
  AUCTION_URGENT_MULTIPLIER: 1.8,
  AUCTION_SEALED_BONUS: 1.3,
  AUCTION_PATIENCE_DECAY: 0.05,
  AUCTION_MAX_PATIENCE: 100,
  AUCTION_BUYER_NAMES: [
    '糖糖商人', '蜜蜜收购家', '甜甜批发商', '可可收藏家',
    '果糖大盗', '麦芽糖大师', '焦糖猎人', '冰糖行家',
    '蔗糖贵族', '牛轧糖达人', '太妃糖老板', '棉花糖买家',
  ],
  AUCTION_BUYER_AVATARS: ['🧑‍💼', '👩‍🍳', '🧙‍♂️', '👸', '🤴', '👨‍🌾', '👩‍🔬', '🎩', '🦸', '🧝'],
};
